...
| :-: | :------------------: | :-----------: | :---: | :------------------------------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|  1  |   Alícia  |  Trabalha no mercado |      <img src="../gdd_images/Alicia.jpg" style="width:50px">   |                   M                        |
|  2  | Eduardo |     Trabalha no salão de beleza    |<img src="../gdd_images/Eduardo.jpg" style="width:100px"> |  |
|  3  |  Lucas  |   Trabalha no restaurante de comida japonesa   | <img src="../gdd_images/LucasBorten.jpg" style="width:20px">  |         
