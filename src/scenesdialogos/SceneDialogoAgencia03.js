...
const ROTEIRO = [
  {
    ...
    narracao:
      "Agencia tensa. Clima de cobranca intensa. Gerente apressado.\nAqui e o nivel mais exigente. Cada palavra conta.",
    npcInicial: "Bom dia. Pode falar, mas tenho pouco tempo.",
    escolhas: [
      {
        letra: "A",
        texto: "Entendo. Vou ser direto e objetivo.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Bom dia! Vim para fortalecer nossa parceria.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Bom dia! Trouxe varias solucoes para apresentar.",
        tipo: "errada",
      },
    ],
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Analisei sua carteira e vi tres clientes com alto potencial de ativacao imediata.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Quero apresentar as novidades da Cielo para a agencia.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Trouxe material sobre todos os produtos que temos disponíveis.",
        tipo: "errada",
      },
    ],
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Um posto de gasolina com alto volume, uma loja de roupas em expansao e um supermercado sem solucao atual.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Clientes com perfil comercial que podem usar maquininha.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Varios clientes que ainda nao tem a Cielo.",
        tipo: "errada",
      },
    ],
  ...
  },
  {
    ...
    narracao: null,
    npcInicial:
      "Mas eles ja recebem proposta de outras operadoras toda semana.",
    escolhas: [
      {
        letra: "A",
        texto:
          "A diferenca esta no suporte 24h e na estabilidade da Cielo, que nao para o caixa do cliente.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "A Cielo e mais conhecida e confiavel que a maioria.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "A Cielo tem melhores taxas do mercado.",
        tipo: "errada",
      },
    ],
    npcResposta:
      "Se voce tiver um argumento concreto, pode ajudar a convencer.",
  },
  {
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Proponho visita conjunta com o gerente PJ. Sua presenca aumenta a credibilidade e facilita o fechamento.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Posso visitar esses clientes e trazer retorno depois.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Vou ligar para eles hoje e ja apresentar a proposta.",
        tipo: "errada",
      },
    ],
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Sugiro esta semana, dois por dia, comecando pelos de maior volume para garantir resultado rapido.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Podemos combinar conforme sua agenda.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Quando voce tiver disponivel, eu me adapto.",
        tipo: "errada",
      },
    ],
  ...
  },
  {
    ...
    narracao: null,
    npcInicial:
      "Nossa meta esta atrasada. Preciso de resultado essa semana, nao no mes que vem.",
    escolhas: [
      {
        letra: "A",
        texto:
          "Exatamente por isso foquei em clientes prontos para fechar. O posto ja pediu proposta.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Entendo a urgencia. Vou me esforcar para agilizar.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "Vou ver o que consigo fazer dentro do prazo.",
        tipo: "errada",
      },
    ],
    npcResposta:
      "Se o posto ja pediu proposta, isso muda o quadro. Vamos priorizar.",
  },
  {
    titulo: "CENA 8 - RETENCAO DE CARTEIRA",
    narracao: null,
    npcInicial:
      "Tenho um cliente antigo reclamando de taxa. Risco de cancelamento.",
    escolhas: [
      {
        letra: "A",
        texto:
          "Posso visitá-lo hoje e entender o caso. Muitas vezes renegociar a taxa mantem o cliente e aumenta o volume.",
        tipo: "correta",
      },
      {
        letra: "B",
        texto: "Posso entrar em contato com ele para tentar resolver.",
        tipo: "neutra",
      },
      {
        letra: "C",
        texto: "A gente pode oferecer um desconto para ele ficar.",
        tipo: "errada",
      },
    ],
    npcResposta:
      "Se voce resolver esse caso, libero minha agenda para as visitas conjuntas.",
  },
  {
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Envio um resumo hoje com os tres clientes, o status do antigo e as datas das visitas.",
        tipo: "correta",
      },
      {
        letra: "B",
    ...
    npcResposta:
      "Perfeito. Essa organizacao e o que diferencia um bom parceiro.",
  },
  {
    ...
    escolhas: [
      {
        letra: "A",
        texto:
          "Agradeco o alinhamento. Vou executar o plano e trazer resultado concreto essa semana.",
        tipo: "correta",
      },
...
export default class SceneDialogoAgencia03 extends SceneDialogoBase {
  ...
  preload() {
    if (!this.textures.exists("falaAgencia03")) {
      this.load.image(
        "falaAgencia03",
        "src/assets/imagens/imagensFalas/Agência 03 - GG - F.png",
      );
    }
  }
  ...
  create() {
    ...
    // Imagem NPC
    this.imgNpc = this.add
      .image(CX, IMG_CY, "falaAgencia03")
      .setDepth(1)
      .setDisplaySize(W, IMG_H);

    // Painel de diálogo
    const panelBg = this.add
      .rectangle(PANEL_CX, PANEL_CY, W - 40, PANEL_H - 10, 0x111827, 0.95)
      .setStrokeStyle(2, 0x3b82f6)
      .setDepth(2);

    const NOME_NPC = "Gerente da Agência";
    this.textoNome = this.add
      .text(PANEL_CX - (W - 40) / 2 + 20, PANEL_TOP + 14, NOME_NPC, {
        fontSize: "18px",
        color: "#60a5fa",
        fontStyle: "bold",
        resolution: 4,
    ...
    this.textoCarregando = this.add
      .text(PANEL_CX, PANEL_TOP + 38, "Aguardando resposta...", {
        fontSize: "16px",
        color: "#94a3b8",
        resolution: 4,
      })
    ...
    this.textoCieloCoin = this.add
      .text(W - 20, 20, `Cielo Coins: ${getScore(this.registry)}  (+0 aqui)`, {
        fontSize: "18px",
        color: "#fbbf24",
        fontStyle: "bold",
        resolution: 4,
    ...
    this.botoesEscolha = LETRAS.map((letra, i) => {
      ...
      const bg = this.add
        .rectangle(BTN_X, by, BTN_W, BTN_H, COR_NEUTRO)
        .setStrokeStyle(1, 0x3b82f6)
        .setDepth(3)
        .setVisible(false)
        .setInteractive();
      const labelLetra = this.add
        .text(BTN_X - BTN_W / 2 + 20, by, letra, {
          fontSize: "16px",
          color: "#60a5fa",
          fontStyle: "bold",
          resolution: 4,
      ...
      const txtEscolha = this.add
        .text(BTN_X - BTN_W / 2 + 44, by, "", {
          fontSize: "14px",
          color: "#e2e8f0",
          wordWrap: { width: BTN_W - 60 },
          resolution: 4,
        })
        .setDepth(4)
        .setOrigin(0, 0.5)
      ...
      bg.on("pointerover", () => {
        if (bg.visible) bg.setFillStyle(COR_HOVER);
      });
      bg.on("pointerout", () => {
        if (bg.visible) bg.setFillStyle(COR_NEUTRO);
      });
    ...
    this.btnContinuar = this.add
      .rectangle(CX, PANEL_TOP + PANEL_H - 30, 220, 36, 0x1e40af)
      .setStrokeStyle(1, 0x3b82f6)
      .setDepth(3)
      .setVisible(false)
      .setInteractive();
    this.txtContinuar = this.add
      .text(CX, PANEL_TOP + PANEL_H - 30, "Continuar  →", {
        fontSize: "15px",
        color: "#ffffff",
        resolution: 4,
      })
  ...
  _mostrarResultadoFinal() {
    ...
    let avaliacao, cor;
    if (pct >= 90) {
      avaliacao = "Parceiro exemplar! Agencia conquistada.";
      cor = "#44ff88";
    } else if (pct >= 70) {
      avaliacao = "Bom desempenho. Quase perfeito.";
      cor = "#88ccff";
    } else if (pct >= 50) {
      avaliacao = "Razoavel. Cuidado com as erradas.";
      cor = "#ffcc44";
    } else {
      avaliacao = "Precisa melhorar muito. Tente de novo.";
      cor = "#ff6644";
    }
  ...
  async _chamarLLM(escolha, cena) {
    ...
    const guias = {
      correta:
        "O vendedor foi estratégico e demonstrou preparo. Responda de forma objetiva e positiva.",
      neutra:
        "O vendedor foi aceitável mas sem impacto. Responda de forma neutra.",
      errada:
        "O vendedor foi superficial. Responda com ceticismo, sem encerrar.",
    };
