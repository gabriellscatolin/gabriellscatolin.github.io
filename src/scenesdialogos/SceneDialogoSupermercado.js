...
// ─── Roteiro Fase 8 – Supermercado ───────────────────────────────────────────
const ROTEIRO = [
  {
    titulo: "CENA 0 – OBSERVAÇÃO / MINI-INTERAÇÃO",
    narracao: "Supermercado grande. Muitos caixas. Fluxo constante.\n\"Observe a escala.\"",
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Bom dia. Operação grande por aqui.",                                                tipo: "neutra"  },
      { letra: "B", texto: "Bom dia. Aqui qualquer detalhe impacta bastante o resultado.",                      tipo: "correta" },
      { letra: "C", texto: "Bom dia. Tenho uma solução completa de pagamentos para o seu negócio.",             tipo: "errada"  },
    ],
    npcResposta: "Bom dia. Aqui tudo precisa fazer sentido em escala.",
  },
  {
    titulo: "CENA 1 – ABORDAGEM",
    narracao: null,
    npcInicial: "Pode falar. Seja objetivo.",
    escolhas: [
      { letra: "A", texto: "Posso te mostrar impacto em custo e performance?",                  tipo: "correta" },
      { letra: "B", texto: "Vim te apresentar as soluções da Cielo.",                           tipo: "neutra"  },
      { letra: "C", texto: "Tenho uma solução que melhora sua operação e a experiência.",       tipo: "errada"  },
    ],
    npcResposta: "Se tiver impacto real, faz sentido.",
  },
  {
    ...
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "No pagamento, pesa mais custo ou performance?",                     tipo: "correta" },
      { letra: "B", texto: "Você olha mais volume ou comportamento dos caixas?",                tipo: "neutra"  },
      { letra: "C", texto: "Vou te explicar a solução da Cielo.",                               tipo: "errada"  },
    ],
    npcResposta: "Os dois. Um impacta o outro.",
  },
  {
    titulo: "CENA 3 – DIAGNÓSTICO",
    narracao: null,
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Hoje você perde mais em fila, falha ou retrabalho?",                tipo: "correta" },
      { letra: "B", texto: "Em escala, pequenas falhas viram grandes perdas.",                  tipo: "neutra"  },
      { letra: "C", texto: "Se tiver algo melhor, você avaliaria trocar?",                      tipo: "errada"  },
    ],
    npcResposta: "Falha e lentidão pesam mais. A escala multiplica.",
  },
  {
    titulo: "CENA 4 – OBJEÇÃO",
    narracao: null,
    npcInicial: "Preciso ver números.",
    escolhas: [
      { letra: "A", texto: "Perfeito. Aqui operação vira resultado rápido.",                    tipo: "correta" },
      { letra: "B", texto: "Posso mostrar ganhos operacionais e depois conectar com números.",  tipo: "neutra"  },
      { letra: "C", texto: "Nem tudo depende só de número. A operação também conta.",           tipo: "errada"  },
    ],
    npcResposta: "Preciso ver essa relação com clareza.",
  },
  {
    titulo: "CENA 5 – VALOR (CUSTO)",
    narracao: null,
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Menos falha e atraso reduzem custo oculto.",                        tipo: "correta" },
      { letra: "B", texto: "A solução melhora o funcionamento do pagamento.",                   tipo: "neutra"  },
      { letra: "C", texto: "Traz mais tecnologia e melhora a operação.",                        tipo: "errada"  },
    ],
    npcResposta: "Custo oculto existe. Preciso ver o impacto.",
  },
  {
    titulo: "CENA 6 – VALOR (PERFORMANCE)",
    narracao: null,
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Desempenho estável evita gargalo no pico.",                         tipo: "correta" },
      { letra: "B", texto: "Uma solução robusta melhora a operação.",                           tipo: "neutra"  },
      { letra: "C", texto: "Ajuda o time a trabalhar melhor no dia a dia.",                     tipo: "errada"  },
    ],
    npcResposta: "No pico, isso faz diferença.",
  },
  {
    titulo: "CENA 7 – ESCALA",
    narracao: null,
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Pequenos ganhos por caixa viram resultado.",                        tipo: "correta" },
      { letra: "B", texto: "Em vários caixas, tudo precisa ser consistente.",                   tipo: "neutra"  },
      { letra: "C", texto: "Melhorias se espalham pela operação.",                              tipo: "errada"  },
    ],
    npcResposta: "Aqui nada é pequeno.",
  },
  {
    titulo: "CENA 8 – OBJEÇÃO FINAL",
    narracao: null,
    npcInicial: "Tem que fazer sentido financeiro.",
    escolhas: [
      { letra: "A", texto: "Mostro ganho operacional com impacto financeiro.",                  tipo: "correta" },
      { letra: "B", texto: "Podemos olhar operação, experiência e números.",                   tipo: "neutra"  },
      { letra: "C", texto: "A operação já mostra que dá para melhorar.",                        tipo: "errada"  },
    ],
    npcResposta: "Preciso enxergar isso com clareza.",
  },
  {
    ...
    npcInicial: null,
    escolhas: [
      { letra: "A", texto: "Te mostro o impacto na prática. Se fizer sentido, seguimos.",       tipo: "correta" },
      { letra: "B", texto: "Quer ver a solução completa agora?",                                tipo: "neutra"  },
      { letra: "C", texto: "Vamos avançar e melhorar sua operação.",                            tipo: "errada"  },
    ],
    npcResposta: "Pode mostrar. Quero ver na prática.",
  },
];

const CAPITULO  = "chapter1";
const FASE      = "supermercado";
const N_CENAS   = ROTEIRO.length; // 10 cenas
...
export default class SceneDialogoSupermercado extends Phaser.Scene {
  constructor() {
  ...
  create() {
    ...
    // ── Imagem do supermercado (topo) ────────────────────────────────────────
    const img = this.add.image(CX, IMG_CY, "falaSupermercado")
    ...
    // ── Nome do NPC ──────────────────────────────────────────────────────────
    this.textoNome = this.add.text(CX - (BTN_W / 2), NOME_Y, "Gerente  —  Supermercado", {
    ...
    // ── Loading ──────────────────────────────────────────────────────────────
    this.textoCarregando = this.add.text(CX, CONT_Y, "Gerente está pensando...", {
  ...
  _criarTutorial(W, H, CX, CY) {
    ...
    const linhas = [
      { icone: "🎯", texto: "Você é um vendedor da Cielo negociando com o gerente\nde um supermercado sobre soluções de pagamento." },
      { icone: "💬", texto: "Em cada cena, o gerente fala algo. Escolha a melhor resposta\npara avançar a conversa de forma estratégica." },
      { icone: "🪙", texto: "Cada escolha vale Cielo Coins:\n✅ Resposta correta = +2   ⚪ Neutra = +1   ❌ Errada = +0" },
      { icone: "🤖", texto: "O gerente responde com inteligência artificial,\nadaptando a fala com base na sua escolha." },
  ...
  async _chamarLLM(escolha, cena) {
    ...
    const system =
      `Você é gerente de um supermercado grande com múltiplos caixas. É estratégico, focado em operação e números. ` +
      `Está conversando com um vendedor da Cielo sobre soluções de pagamento para sua operação em escala.\n` +
    ...
    try {
      ...
      console.warn("[SceneDialogoSupermercado] Falha na LLM, usando roteiro:", err.message);
      return cena.npcResposta;
    }
  }
